...
begin
  ...
  frmShadow.Left := frmMain.Left + MulDiv(7, Monitor.PixelsPerInch, PixelsPerInch);
  frmShadow.Top := frmMain.Top + MulDiv(1, Monitor.PixelsPerInch, PixelsPerInch);
  frmShadow.Width := frmMain.Width + MulDiv(1, Monitor.PixelsPerInch, PixelsPerInch);
  frmShadow.Height := frmMain.Height + titlebarheight + MulDiv(7, Monitor.PixelsPerInch, PixelsPerInch);
